...
ActiveRecord::Schema.define(version: 20171103104129) do
  ...
  create_table "areas_assessments", id: false, force: :cascade do |t|
  ...
  create_table "assessments_attitudes", id: false, force: :cascade do |t|
    t.integer "assessment_id"
